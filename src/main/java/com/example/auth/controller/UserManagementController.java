...
public class UserManagementController {
    ...
    @Operation(summary = "Create a new user",
            description = "Creates a user and links them to a role (User + User_Role) and a project (User_Project)")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get all users (paginated)",
            description = "Returns a paginated list of all users with their roles and assigned projects")
    ...
    @Operation(summary = "Update a user",
            description = "Partially updates user fields. Also updates User_Role and User_Project if role/project IDs are provided.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Delete a user",
            description = "Deletes the user and all associated User_Role and User_Project records")
    @ApiResponses(value = {
